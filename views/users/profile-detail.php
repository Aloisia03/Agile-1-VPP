            ...
            <div class="card shadow rounded-4 border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="border rounded-4 overflow-hidden bg-white">
                        ...
                        <div class="d-flex justify-content-between px-4 py-3 border-bottom bg-light">
                        ...
                        <div class="px-4 py-3 bg-light">
                            ...
                            <div>
                                <?= nl2br(htmlspecialchars($user['address'] ?? 'Chưa cập nhật')) ?>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="/Agile-1-VPP/profile/update"
                           class="btn btn-outline-secondary">
                            Cập nhật thông tin
                        </a>

                        <a href="/Agile-1-VPP/home"
                           class="btn btn-outline-secondary">
                            Trang chủ
                        </a>

                        <a href="/Agile-1-VPP/logout"
